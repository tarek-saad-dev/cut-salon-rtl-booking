...
const ARABIC_ERROR_MESSAGES: Partial<Record<PublicBookingErrorCode, string>> = {
  ...
  MIN_NOTICE_NOT_MET: "الميعاد اللي اخترته لسه ما عادش متاح، يرجى اختيار وقت تاني",
  BOOKING_PLAN_UNAVAILABLE: "تعذر تجهيز الموعد حالياً، يرجى اختيار وقت آخر",
...
const ENGLISH_ERROR_MESSAGES: Partial<Record<PublicBookingErrorCode, string>> = {
  ...
  MIN_NOTICE_NOT_MET: "That time just became unavailable — please pick another slot",
  BOOKING_PLAN_UNAVAILABLE: "That slot can’t be booked right now — please pick another time",
