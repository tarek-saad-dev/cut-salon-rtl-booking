...
export const bookingCatalog = {
  ...
  actions: {
    ...
    doneThanks: { ar: "تم، شكراً", en: "Done, thanks" },
    copy: { ar: "نسخ", en: "Copy" },
  ...
  branch: {
    ...
    titleBarberFirst: { ar: "فرع {name}", en: "{name}’s branch" },
  ...
  service: {
    title: { ar: "اختر الخدمة الأساسية", en: "Choose your main service" },
  ...
  review: {
    ...
    durationFinal: { ar: "المدة النهائية", en: "Final duration" },
    phone: { ar: "الهاتف", en: "Phone" },
    name: { ar: "الاسم", en: "Name" },
  },
  success: {
    title: { ar: "تم تأكيد حجزك بنجاح", en: "Booking confirmed" },
    subtitle: { ar: "احتفظ بالتفاصيل التالية لموعدك", en: "Keep these details for your appointment" },
    bookingCode: { ar: "كود الحجز", en: "Booking code" },
    summary: { ar: "ملخص الموعد", en: "Appointment summary" },
    confirmationDetailsAria: { ar: "تفاصيل تأكيد الحجز", en: "Booking confirmation details" },
    craftsman: { ar: "الصنايعي", en: "Barber" },
