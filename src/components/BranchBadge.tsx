    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-2 rounded-xl border text-xs font-bold transition-all duration-300 ${
            hasConfirmedBranch
      ...
      <PopoverContent
        align="end"
        className="w-80 bg-cut-black border-cut-gold/20 p-4 rounded-2xl shadow-2xl"
        dir="rtl"
      >
        <p className="text-cut-ivory/40 text-[11px] font-bold uppercase tracking-widest mb-3">اختر فرعك</p>
        <BranchPicker
          branches={branches}
